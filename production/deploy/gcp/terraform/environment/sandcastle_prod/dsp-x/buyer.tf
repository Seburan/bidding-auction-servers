...
locals {
  ...
  buyer_operator = "dsp-x" # Example: "buyer-1"
  ...
  frontend_domain_ssl_certificate_id = "projects/gtech-privacy-baservices-prod/locations/global/certificates/wildcard-ba-privacy-sandbox-demos-dsp-x-dev-cert" # Example: "projects/${local.gcp_project_id}/global/sslCertificates/bfe-${local.environment}"
  frontend_certificate_map_id        = "//certificatemanager.googleapis.com/projects/gtech-privacy-baservices-prod/locations/global/certificateMaps/wildcard-ba-privacy-sandbox-demos-dsp-x-dev-cert-map" # Example: "//certificatemanager.googleapis.com/projects/test/locations/global/certificateMaps/wildcard-cert-map"
  frontend_ssl_policy_id             = "" # Example: "projects/${local.gcp_project_id}/global/sslPolicies/bfe-ssl-policy
  buyer_domain_name                  = "bfe.ba.privacy-sandbox-demos-dsp-x.dev" # Example: bfe-gcp.com
  frontend_dns_zone                  = "bfe-ba-privacy-sandbox-demos-dsp-x-dev" # Example: "bfe-gcp-com"
...
module "buyer" {
  ...
  runtime_flags = merge({
    ...
    COLLECTOR_ENDPOINT        = "collector-dsp-x-${each.key}.bfe.ba.privacy-sandbox-demos-dsp-x.dev:4317" # Example: "collector-buyer-1-${each.key}.bfe-gcp.com:4317"
  ...
  service_account_email              = "bidding-auction-dsp-x@gtech-privacy-baservices-prod.iam.gserviceaccount.com"    # Example: "bidding-auction-services@{local.gcp_project_id}.iam.gserviceaccount.com"
