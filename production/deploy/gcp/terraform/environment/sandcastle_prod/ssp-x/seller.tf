...
locals {
  ...
  frontend_domain_ssl_certificate_id = "projects/gtech-privacy-baservices-prod/locations/global/certificates/wildcard-ba-privacy-sandbox-demos-ssp-x-dev-cert" # Example: "projects/${local.gcp_project_id}/global/sslCertificates/sfe-${local.environment}"
  frontend_certificate_map_id        = "//certificatemanager.googleapis.com/projects/gtech-privacy-baservices-prod/locations/global/certificateMaps/wildcard-ba-privacy-sandbox-demos-ssp-x-dev-cert-map" # Example: "//certificatemanager.googleapis.com/projects/test/locations/global/certificateMaps/wildcard-cert-map"
  frontend_ssl_policy_id             = "" # Example: "projects/${local.gcp_project_id}/global/sslPolicies/sfe-ssl-policy
  seller_domain_name                 = "sfe.ba.privacy-sandbox-demos-ssp-x.dev" # Example: sfe-gcp.com
  frontend_dns_zone                  = "sfe-ba-privacy-sandbox-demos-ssp-x-dev" # Example: "sfe-gcp-com"
...
module "seller" {
  ...
  runtime_flags = merge({
    ...
    COLLECTOR_ENDPOINT                  = "collector-ssp-x-${each.key}.sfe.ba.privacy-sandbox-demos-ssp-x.dev:4317" # Example: "collector-seller-1-${each.key}.sfe-gcp.com:4317"
  ...
  service_account_email              = "bidding-auction-ssp-x@gtech-privacy-baservices-prod.iam.gserviceaccount.com"    # Example: "bidding-auction-services@{local.gcp_project_id}.iam.gserviceaccount.com"
