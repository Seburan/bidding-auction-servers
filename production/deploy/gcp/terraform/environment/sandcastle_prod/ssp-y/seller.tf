...
locals {
  gcp_project_id  = "gtech-privacy-baservices-prod" # Example: "your-gcp-project-123"
  environment     = "prod" # Must be <= 3 characters. Example: "abc"
  image_repo      = "us-central1-docker.pkg.dev/gtech-privacy-baservices-prod/bidding-auction-servers-image-repo/prod" # Example: "us-docker.pkg.dev/your-gcp-project-123/services"
  seller_operator = "ssp-y" # Example: "seller-1"
  ...
  frontend_domain_ssl_certificate_id = "projects/gtech-privacy-baservices-prod/locations/global/certificates/wildcard-ba-privacy-sandbox-demos-ssp-y-dev-cert" # Example: "projects/${local.gcp_project_id}/global/sslCertificates/sfe-${local.environment}"
  frontend_certificate_map_id        = "//certificatemanager.googleapis.com/projects/gtech-privacy-baservices-prod/locations/global/certificateMaps/wildcard-ba-privacy-sandbox-demos-ssp-y-dev-cert-map" # Example: "//certificatemanager.googleapis.com/projects/test/locations/global/certificateMaps/wildcard-cert-map"
  frontend_ssl_policy_id             = "" # Example: "projects/${local.gcp_project_id}/global/sslPolicies/sfe-ssl-policy
  seller_domain_name                 = "sfe.ba.privacy-sandbox-demos-ssp-y.dev" # Example: sfe-gcp.com
  frontend_dns_zone                  = "sfe-ba-privacy-sandbox-demos-ssp-y-dev" # Example: "sfe-gcp-com"
...
module "seller" {
  ...
  runtime_flags = merge({
    ...
    BUYER_SERVER_HOSTS                  = jsonencode({
      "https://privacy-sandbox-demos-dsp-x.dev" = {
        "url"           = "dns:///dsp-x-prod.bfe.ba.privacy-sandbox-demos-dsp-x.dev:443",
        "cloudPlatform" = "GCP"
      },
      "https://privacy-sandbox-demos-dsp-y.dev" = {
        "url"           = "dns:///dsp-y-prod.bfe.ba.privacy-sandbox-demos-dsp-y.dev:443",
        "cloudPlatform" = "GCP"
      }
    })
    ...
    COLLECTOR_ENDPOINT                  = "collector-ssp-y-${each.key}.sfe.ba.privacy-sandbox-demos-ssp-y.dev:4317" # Example: "collector-seller-1-${each.key}.sfe-gcp.com:4317"
  ...
  service_account_email              = "bidding-auction-ssp-y@gtech-privacy-baservices-prod.iam.gserviceaccount.com"    # Example: "bidding-auction-services@{local.gcp_project_id}.iam.gserviceaccount.com"
  ...
  collector_startup_script = templatefile("../../../services/autoscaling/collector_startup.tftpl", {
    ...
    gcs_bucket               = "gtech-privacy-baservices-prod-collector" # Example: ${name of a gcs bucket}
