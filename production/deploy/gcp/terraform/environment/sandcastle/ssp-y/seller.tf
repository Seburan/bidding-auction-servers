...
locals {
  ...
  frontend_domain_ssl_certificate_id = "projects/gtech-privacy-baservices-dev/locations/global/certificates/wildcard-privacy-sandbox-demos-ssp-y-dev-cert" # Example: "projects/${local.gcp_project_id}/global/sslCertificates/sfe-${local.environment}"
  frontend_certificate_map_id        = "//certificatemanager.googleapis.com/projects/gtech-privacy-baservices-dev/locations/global/certificateMaps/wildcard-privacy-sandbox-demos-ssp-y-dev-cert-map" # Example: "//certificatemanager.googleapis.com/projects/test/locations/global/certificateMaps/wildcard-cert-map"
  frontend_ssl_policy_id             = "" # Example: "projects/${local.gcp_project_id}/global/sslPolicies/sfe-ssl-policy
  seller_domain_name                 = "sfe.privacy-sandbox-demos-ssp-y.dev" # Example: sfe-gcp.com
  frontend_dns_zone                  = "sfe-privacy-sandbox-demos-ssp-y-dev" # Example: "sfe-gcp-com"
