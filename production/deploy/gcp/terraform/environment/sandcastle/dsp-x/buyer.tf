...
locals {
  ...
  frontend_domain_ssl_certificate_id = "projects/gtech-privacy-baservices-dev/locations/global/certificates/wildcard-privacy-sandbox-demos-dsp-x-dev-cert" # Example: "projects/${local.gcp_project_id}/global/sslCertificates/bfe-${local.environment}"
  frontend_certificate_map_id        = "//certificatemanager.googleapis.com/projects/gtech-privacy-baservices-dev/locations/global/certificateMaps/wildcard-privacy-sandbox-demos-dsp-x-dev-cert-map" # Example: "//certificatemanager.googleapis.com/projects/test/locations/global/certificateMaps/wildcard-cert-map"
  frontend_ssl_policy_id             = "" # Example: "projects/${local.gcp_project_id}/global/sslPolicies/bfe-ssl-policy
  buyer_domain_name                  = "bfe.privacy-sandbox-demos-dsp-x.dev" # Example: bfe-gcp.com
  frontend_dns_zone                  = "bfe-privacy-sandbox-demos-dsp-x-dev" # Example: "bfe-gcp-com"
...
module "buyer" {
  ...
  runtime_flags = merge({
    ...
    COLLECTOR_ENDPOINT        = "collector-dsp-x-${each.key}.bfe.privacy-sandbox-demos-dsp-x.dev:4317" # Example: "collector-buyer-1-${each.key}.bfe-gcp.com:4317"
  ...
  service_account_email              = "bidding-auction-dsp-x@gtech-privacy-baservices-dev.iam.gserviceaccount.com"    # Example: "bidding-auction-services@{local.gcp_project_id}.iam.gserviceaccount.com"
